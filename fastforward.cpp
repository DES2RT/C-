...
{
#ifdef __MSVC__
  std::cout << R"msc(Windows programs execute with a tiny stack.

  This code generates some classes with a million bytes.
  These classes are created local to a function, IE, on the stack.
